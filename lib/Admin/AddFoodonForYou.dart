...
class AddFoodOnForYou extends StatefulWidget {
  const AddFoodOnForYou({Key? key}) : super(key: key);

  @override
  State<AddFoodOnForYou> createState() => _AddFoodOnForYouState();
}

class _AddFoodOnForYouState extends State<AddFoodOnForYou> {
    ...
    if (selectedImage != null && nameController.text.isNotEmpty) {
      ...
      try {
        ...
        Map<String, dynamic> addItem = {
          ...
          "discount": double.tryParse(discountController.text) ?? 10,
